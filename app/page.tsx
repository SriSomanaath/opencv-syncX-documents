...
export default function Home() {
  return (
    <div className="relative w-full flex flex-col justify-center items-center">
      ...
      <Banner />
      <Footer2 />
      <div className="absolute left-0 top-0 h-full w-10 sm:w-16 md:w-20 bg-gradient-to-r from-background to-transparent"></div>
      <div className="absolute right-0 top-0 h-full w-10 sm:w-16 md:w-20 bg-gradient-to-l from-background to-transparent"></div>
    </div>
  )
}
